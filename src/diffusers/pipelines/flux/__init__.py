...
try:
    ...
    _import_structure["pipeline_flux_kontext_pe_edited"] = ["PEFluxKontextPipeline"]
    _import_structure["pipeline_flux_kontext_pe_edited_enable_mask"] = ["MaskPEFluxKontextPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_flux_kontext_pe_edited import PEFluxKontextPipeline
        from .pipeline_flux_kontext_pe_edited_enable_mask import MaskPEFluxKontextPipeline
